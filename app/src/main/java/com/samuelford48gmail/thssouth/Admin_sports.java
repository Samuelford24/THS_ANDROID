...
public class Admin_sports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_sports);
        football = FirebaseDatabase.getInstance().getReference("Football");
        tennis = FirebaseDatabase.getInstance().getReference("Boys_tennis");
        bsoccer = FirebaseDatabase.getInstance().getReference("Boys_soccer");
        gsoccer = FirebaseDatabase.getInstance().getReference("Girls_soccer");
        volleyball = FirebaseDatabase.getInstance().getReference("Girls_volleyball");
        golf = FirebaseDatabase.getInstance().getReference("Girls_golf");
        bcc = FirebaseDatabase.getInstance().getReference("Boys_cross-country");
        gcc = FirebaseDatabase.getInstance().getReference("Girls_cross-country");
    }
